...
class employee
{
  ...
  {
     echo "in fileupload";
            $uploaddir = '/home/webonise/Projects/php/App2012/corephp/photos/';
 ...
 function insertvalue($con,$filepath,$name,$age,$gender,$email,$address,$pincode,$technology)
 {
...
$emp->insertvalue($con,$filepath,$name,$age,$gender,$email,$address,$pincode,$etechnology);
